...
public class Dice
{
 ...
 /**
  * @param value_from_dice the value_from_dice to set
  */
 ...
 /**
  * @param starting_num the starting_num to set
  */
 ...
 /**
  * @param bias_dice the bias_dice to set
  */
 ...
 /**
  * @param was_die_rolled the was_die_rolled to set
  */
 ...
 /**
  * @param num_4_rand_function the num_4_rand_function to set
  */
 ...
 /**
  * @param dieRoller the dieRoller to set
  */
